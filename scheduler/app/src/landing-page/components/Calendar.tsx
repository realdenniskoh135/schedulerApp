...
const Calendar = () => {
  return (
    <div>
      <h2 className="text-base font-semibold leading-6 text-gray-900 dark:text-white">Upcoming meetings</h2>
      <div className="lg:grid lg:grid-cols-12 lg:gap-x-16">
          ...
          <div className="isolate mt-2 grid grid-cols-7 gap-px rounded-lg bg-gray-200 dark:bg-gray-700 text-sm shadow ring-1 ring-gray-200 dark:ring-gray-700">
            {days.map((day, dayIdx) => (
              ...
              className={classNames(
                'py-1.5 hover:bg-gray-100 focus:z-10 dark:hover:bg-gray-600',
                day.isCurrentMonth ? 'bg-white dark:bg-gray-800' : 'bg-gray-50 dark:bg-gray-600',
                (day?.isSelected || day?.isToday) ? 'font-semibold' : '',
                day.isSelected ? 'text-white' : '',
                !day.isSelected && day.isCurrentMonth && !day.isToday ? 'text-gray-900 dark:text-white' : '',
            ...
            >
              <time
                ...
                className={classNames(
                  ...
                  day.isSelected && !day.isToday ? 'bg-gray-900 dark:bg-gray-800' : ''
                )}
              >
        ...
        <ol className="mt-4 divide-y divide-gray-100 dark:divide-gray-700 text-sm leading-6 lg:col-span-7 xl:col-span-8">
          {meetings.map((meeting) => (
            <li key={meeting.id} className="relative flex space-x-6 py-6 xl:static">
              <img src={meeting.imageUrl} alt="" className="h-14 w-14 flex-none rounded-full" />
              <div className="flex-auto">
                <h3 className="pr-10 font-semibold text-gray-900 dark:text-white xl:pr-0">{meeting.name}</h3>
              ...
              <Menu as="div" className="absolute right-0 top-6 xl:relative xl:right-auto xl:top-auto xl:self-center">
                <div>
                  <MenuButton className="-m-2 flex items-center rounded-full p-2 text-gray-500 hover:text-gray-600 dark:text-gray-400 dark:hover:text-gray-300">
